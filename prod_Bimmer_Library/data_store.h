...
const char* BTM_STATUS [22] PROGMEM = {
  "Power OSS state" , "Pairing state (discoverable mode)" , "Power ON state" , "Pairing successful" , "Pairing failed" , "HS/HF Link Established" , "A2DP Link Established" , "HF Link disconnected" , "A2DP Link disconnected" , "SCO Link Connected" , "SCO Link Disconnected" , "AVRCP link established" , "AVRCP link disconnected" , "Standard SPP connected" , "Standard_SPP / iAP disconnected" , "Standby state" , "iAP connected" , "ACL disconnected" , "MAP connected" , "MAP operation forbidden" , "MAP disconnected" , "ACL connected" };
