...
const byte MFL_UP_RELEASE [6] PROGMEM = {
  0x50 , 0x04 , 0x68 , 0x3B , 0x21 , 0x26  }; // Steering up Release
const byte MFL_DOWN [6] PROGMEM = {
...
const byte LOCK_UNLOCK [6] PROGMEM = {
  0x3F , 0x05 , 0x00 , 0x0C , 0x97 , 0x01 }; // Lock/Unlock
const byte CENTRE_LOCK [7] PROGMEM = {
  0x00 , 0x05 , 0xBF , 0x7A , 0x20 , 0x0C , 0xEC}; // Centre Console Lock
const byte CENTRE_UNLOCK [7] PROGMEM = {
  0x00 , 0x05 , 0xBF , 0x7A , 0x10 , 0x0C , 0xDC}; // Centre Console Unlock
