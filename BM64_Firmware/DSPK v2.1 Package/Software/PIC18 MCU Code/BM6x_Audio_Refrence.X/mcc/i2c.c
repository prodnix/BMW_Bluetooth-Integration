...
#define I2C_WRITE_COLLISION_STATUS_BIT         SSP2CON1bits.WCOL     // Defines the write collision status bit.
#define I2C_MODE_SELECT_BITS                   SSP2CON1bits.SSPM     // I2C Master Mode control bit.
#define I2C_MASTER_ENABLE_CONTROL_BITS         SSP2CON1bits.SSPEN    // I2C port enable control bit.
...
void I2C_Initialize(void)
{
    ...
    SSP2ADD = 0x28;             //100kbps, speed = FOSC/(4 * (SSPADD + 1))
