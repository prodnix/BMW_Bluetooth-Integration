...
void TMR0_Initialize(void)
{
    ...
    // TMR0ON enabled; T0SE Increment_hi_lo; PSA assigned; T0CS FOSC/4; T08BIT 16-bit; T0PS 1:2; 
    T0CON = 0x10;//0x90;    //TMR0CON disabled

    //FOSC = 16MHZ, 16MHZ/4/2 = 2MHZ, 2000 clock = 1ms, 65536 - 2000 = 63536 = F830
    TMR0H = 0xF8;
    TMR0L = 0x30;
    timer0ReloadVal16bit = 0xF830;   
